(function(){
  ...
  function defaultSequences() {
    ...
    return [
      { id: "SEQ-FAC-EXPORT", code: "FAC_EXPORT", name: "Facturas de exportación", prefix: "", year: "", month: "", currentNumber: 0, length: 9, reset: "nunca", module: "Comercial", status: "activo", documentType: "01", environment: "PRUEBAS", establishmentCode: "001", emissionPointCode: isBless ? "002" : "001", configurationStatus: "CONFIRMADA", observation: isBless ? "Bless Flower: ventas de exportación 001-002." : "Imperio Flowers: ventas de exportación 001-001." },
      { id: "SEQ-FAC-LOCAL", code: "FAC_LOCAL", name: "Facturas de venta local", prefix: "", year: "", month: "", currentNumber: isBless ? 674 : 0, length: 9, reset: "nunca", module: "Comercial", status: "activo", documentType: "01", environment: "PRUEBAS", establishmentCode: "001", emissionPointCode: isBless ? "003" : "002", configurationStatus: "CONFIRMADA", observation: isBless ? "Bless Flower: ventas locales 001-003; último emitido informado 000000674." : "Imperio Flowers: ventas locales 001-002." },
      { id: "SEQ-NC-EXPORT", code: "NC_EXPORT", name: "Notas de crédito de exportación", prefix: "", year: "", month: "", currentNumber: 0, length: 9, reset: "nunca", module: "Comercial", status: "activo", documentType: "04", environment: "PRUEBAS", establishmentCode: "001", emissionPointCode: isBless ? "002" : "001", configurationStatus: "PENDIENTE_CONFIRMACION", observation: isBless ? "Bless Flower: notas de crédito de exportación 001-002." : "Imperio Flowers: notas de crédito de exportación 001-001." },
      { id: "SEQ-NC-LOCAL", code: "NC_LOCAL", name: "Notas de crédito de venta local", prefix: "", year: "", month: "", currentNumber: 0, length: 9, reset: "nunca", module: "Comercial", status: "activo", documentType: "04", environment: "PRUEBAS", establishmentCode: "001", emissionPointCode: isBless ? "003" : "002", configurationStatus: "PENDIENTE_CONFIRMACION", observation: isBless ? "Bless Flower: notas de crédito locales 001-003." : "Imperio Flowers: notas de crédito locales 001-002." },
