(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("bunch_labels")
    : createFallbackRepository("bunch_labels");

  BlessERP.repositoryModules.operaciones.bunchLabel = repository;
  BlessERP.getBunchLabelRepository = function() {
    return repository;
  };
})();
