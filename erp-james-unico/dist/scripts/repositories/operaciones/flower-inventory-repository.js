(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("flower_inventory")
    : createFallbackRepository("flower_inventory");

  BlessERP.repositoryModules.operaciones.flowerInventory = repository;
  BlessERP.getFlowerInventoryRepository = function() {
    return repository;
  };
})();
