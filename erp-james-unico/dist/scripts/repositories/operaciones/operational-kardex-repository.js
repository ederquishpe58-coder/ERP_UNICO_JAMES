(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("operational_kardex")
    : createFallbackRepository("operational_kardex");

  BlessERP.repositoryModules.operaciones.operationalKardex = repository;
  BlessERP.getOperationalKardexRepository = function() {
    return repository;
  };
})();
