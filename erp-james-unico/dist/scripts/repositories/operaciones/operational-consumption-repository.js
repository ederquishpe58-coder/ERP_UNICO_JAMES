(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("operational_consumptions")
    : createFallbackRepository("operational_consumptions");

  BlessERP.repositoryModules.operaciones.operationalConsumption = repository;
  BlessERP.getOperationalConsumptionRepository = function() {
    return repository;
  };
})();
