(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("operational_dispatch_boxes")
    : createFallbackRepository("operational_dispatch_boxes");

  BlessERP.repositoryModules.operaciones.operationalDispatchBox = repository;
  BlessERP.getOperationalDispatchBoxRepository = function() {
    return repository;
  };
})();
