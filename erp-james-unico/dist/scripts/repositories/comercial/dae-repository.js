(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("dae_records")
    : createFallbackRepository("dae_records");

  BlessERP.repositoryModules.comercial.dae = repository;
  BlessERP.getDaeRepository = function() {
    return repository;
  };
})();
