(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("final_brands")
    : createFallbackRepository("final_brands");

  BlessERP.repositoryModules.comercial.finalBrand = repository;
  BlessERP.getFinalBrandRepository = function() {
    return repository;
  };
})();
