(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("commercial_workflow_events")
    : createFallbackRepository("commercial_workflow_events");

  BlessERP.repositoryModules.comercial.commercialWorkflow = repository;
  BlessERP.getCommercialWorkflowRepository = function() {
    return repository;
  };
})();
