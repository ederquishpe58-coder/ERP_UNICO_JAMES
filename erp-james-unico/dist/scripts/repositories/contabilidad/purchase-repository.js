(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("purchases")
    : createFallbackRepository("purchases");

  BlessERP.repositoryModules.contabilidad.purchase = repository;
  BlessERP.getPurchaseRepository = function() {
    return repository;
  };
})();
