(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("suppliers")
    : createFallbackRepository("suppliers");

  BlessERP.repositoryModules.contabilidad.supplier = repository;
  BlessERP.getSupplierRepository = function() {
    return repository;
  };
})();
