(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("journal_entry_lines")
    : createFallbackRepository("journal_entry_lines");

  BlessERP.repositoryModules.contabilidad.journalEntryLine = repository;
  BlessERP.getJournalEntryLineRepository = function() {
    return repository;
  };
})();
