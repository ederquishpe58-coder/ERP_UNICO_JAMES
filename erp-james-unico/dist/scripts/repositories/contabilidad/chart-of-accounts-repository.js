(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("chart_of_accounts")
    : createFallbackRepository("chart_of_accounts");

  BlessERP.repositoryModules.contabilidad.chartOfAccounts = repository;
  BlessERP.getChartOfAccountsRepository = function() {
    return repository;
  };
})();
