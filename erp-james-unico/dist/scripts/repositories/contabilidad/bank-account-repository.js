(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("bank_accounts")
    : createFallbackRepository("bank_accounts");

  BlessERP.repositoryModules.contabilidad.bankAccount = repository;
  BlessERP.getBankAccountRepository = function() {
    return repository;
  };
})();
