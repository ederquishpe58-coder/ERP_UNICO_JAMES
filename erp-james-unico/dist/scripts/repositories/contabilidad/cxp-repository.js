(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("cxp_documents")
    : createFallbackRepository("cxp_documents");

  BlessERP.repositoryModules.contabilidad.cxp = repository;
  BlessERP.getCxpRepository = function() {
    return repository;
  };
})();
