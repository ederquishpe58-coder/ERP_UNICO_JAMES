(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("material_items")
    : createFallbackRepository("material_items");

  BlessERP.repositoryModules.inventarioMateriales.materialItem = repository;
  BlessERP.getMaterialItemRepository = function() {
    return repository;
  };
})();
