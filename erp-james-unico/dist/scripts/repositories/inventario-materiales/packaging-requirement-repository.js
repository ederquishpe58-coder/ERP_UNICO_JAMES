(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("packaging_requirements")
    : createFallbackRepository("packaging_requirements");

  BlessERP.repositoryModules.inventarioMateriales.packagingRequirement = repository;
  BlessERP.getPackagingRequirementRepository = function() {
    return repository;
  };
})();
