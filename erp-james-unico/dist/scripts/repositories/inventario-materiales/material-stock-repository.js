(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("material_stock")
    : createFallbackRepository("material_stock");

  BlessERP.repositoryModules.inventarioMateriales.materialStock = repository;
  BlessERP.getMaterialStockRepository = function() {
    return repository;
  };
})();
