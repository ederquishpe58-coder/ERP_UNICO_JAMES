(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("app_settings")
    : createFallbackRepository("app_settings");

  BlessERP.repositoryModules.core.settings = repository;
  BlessERP.getSettingsRepository = function() {
    return repository;
  };
})();
