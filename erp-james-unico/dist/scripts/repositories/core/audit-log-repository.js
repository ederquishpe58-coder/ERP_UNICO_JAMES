(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("audit_logs")
    : createFallbackRepository("audit_logs");

  BlessERP.repositoryModules.core.auditLog = repository;
  BlessERP.getAuditLogRepository = function() {
    return repository;
  };
})();
