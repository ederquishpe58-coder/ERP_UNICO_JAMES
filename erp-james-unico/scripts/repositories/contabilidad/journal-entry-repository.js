(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("journal_entries")
    : createFallbackRepository("journal_entries");

  BlessERP.repositoryModules.contabilidad.journalEntry = repository;
  BlessERP.getJournalEntryRepository = function() {
    return repository;
  };
})();
