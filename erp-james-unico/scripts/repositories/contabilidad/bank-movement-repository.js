(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("bank_movements")
    : createFallbackRepository("bank_movements");

  BlessERP.repositoryModules.contabilidad.bankMovement = repository;
  BlessERP.getBankMovementRepository = function() {
    return repository;
  };
})();
