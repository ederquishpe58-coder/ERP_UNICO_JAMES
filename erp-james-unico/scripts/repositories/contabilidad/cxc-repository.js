(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("cxc_documents")
    : createFallbackRepository("cxc_documents");

  BlessERP.repositoryModules.contabilidad.cxc = repository;
  BlessERP.getCxcRepository = function() {
    return repository;
  };
})();
