(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("withholdings_received")
    : createFallbackRepository("withholdings_received");

  BlessERP.repositoryModules.contabilidad.withholdingReceived = repository;
  BlessERP.getWithholdingReceivedRepository = function() {
    return repository;
  };
})();
