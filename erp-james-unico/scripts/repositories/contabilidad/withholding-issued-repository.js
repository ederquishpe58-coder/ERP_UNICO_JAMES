(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("withholdings_issued")
    : createFallbackRepository("withholdings_issued");

  BlessERP.repositoryModules.contabilidad.withholdingIssued = repository;
  BlessERP.getWithholdingIssuedRepository = function() {
    return repository;
  };
})();
