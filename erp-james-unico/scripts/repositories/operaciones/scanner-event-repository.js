(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("scanner_events")
    : createFallbackRepository("scanner_events");

  BlessERP.repositoryModules.operaciones.scannerEvent = repository;
  BlessERP.getScannerEventRepository = function() {
    return repository;
  };
})();
