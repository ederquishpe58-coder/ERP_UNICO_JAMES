(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("flower_reservations")
    : createFallbackRepository("flower_reservations");

  BlessERP.repositoryModules.operaciones.flowerReservation = repository;
  BlessERP.getFlowerReservationRepository = function() {
    return repository;
  };
})();
