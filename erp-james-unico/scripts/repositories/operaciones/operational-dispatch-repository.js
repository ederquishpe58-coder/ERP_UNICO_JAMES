(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("operational_dispatches")
    : createFallbackRepository("operational_dispatches");

  BlessERP.repositoryModules.operaciones.operationalDispatch = repository;
  BlessERP.getOperationalDispatchRepository = function() {
    return repository;
  };
})();
