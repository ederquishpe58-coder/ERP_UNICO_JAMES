(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("customers")
    : createFallbackRepository("customers");

  BlessERP.repositoryModules.comercial.customer = repository;
  BlessERP.getCustomerRepository = function() {
    return repository;
  };
})();
