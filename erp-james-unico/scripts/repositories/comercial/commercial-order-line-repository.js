(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("commercial_order_lines")
    : createFallbackRepository("commercial_order_lines");

  BlessERP.repositoryModules.comercial.commercialOrderLine = repository;
  BlessERP.getCommercialOrderLineRepository = function() {
    return repository;
  };
})();
