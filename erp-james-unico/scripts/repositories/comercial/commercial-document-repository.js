(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("commercial_documents")
    : createFallbackRepository("commercial_documents");

  BlessERP.repositoryModules.comercial.commercialDocument = repository;
  BlessERP.getCommercialDocumentRepository = function() {
    return repository;
  };
})();
