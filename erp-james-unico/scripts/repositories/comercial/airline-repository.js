(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("airlines")
    : createFallbackRepository("airlines");

  BlessERP.repositoryModules.comercial.airline = repository;
  BlessERP.getAirlineRepository = function() {
    return repository;
  };
})();
