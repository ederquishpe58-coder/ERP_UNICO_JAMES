(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("export_products")
    : createFallbackRepository("export_products");

  BlessERP.repositoryModules.comercial.exportProduct = repository;
  BlessERP.getExportProductRepository = function() {
    return repository;
  };
})();
