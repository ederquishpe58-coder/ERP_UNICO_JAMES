(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("cargo_agencies")
    : createFallbackRepository("cargo_agencies");

  BlessERP.repositoryModules.comercial.cargoAgency = repository;
  BlessERP.getCargoAgencyRepository = function() {
    return repository;
  };
})();
