(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("user_profiles")
    : createFallbackRepository("user_profiles");

  BlessERP.repositoryModules.core.user = repository;
  BlessERP.getUserRepository = function() {
    return repository;
  };
})();
