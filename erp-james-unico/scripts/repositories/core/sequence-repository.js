(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("sequences")
    : createFallbackRepository("sequences");

  BlessERP.repositoryModules.core.sequence = repository;
  BlessERP.getSequenceRepository = function() {
    return repository;
  };
})();
