(function(){
  ...
  const repository = BlessERP.createRepositoryBase
    ? BlessERP.createRepositoryBase("material_movements")
    : createFallbackRepository("material_movements");

  BlessERP.repositoryModules.inventarioMateriales.materialMovement = repository;
  BlessERP.getMaterialMovementRepository = function() {
    return repository;
  };
})();
