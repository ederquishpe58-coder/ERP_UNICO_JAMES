(function(){
  ...
  const CAPABILITY_FAMILIES = Object.freeze({
    ...
    "operations.classifiers": ["manage"],
    "operations.bunchers": ["manage"],
    "operations.receptionists": ["manage"],
    "operations.digitizers": ["manage"],
    "operations.scanners": ["manage"],
    "operations.responsibles": ["manage"],
    "operations.varieties": ["manage"],
    "operations.lengths": ["manage"],
    "operations.stem_types": ["manage"],
    "operations.label_types": ["manage"],
  ...
  const ROUTE_CAPABILITIES = Object.freeze({
    ...
    "operations-farms-blocks": "operations.parameters.view",
    "operations-varieties": "operations.parameters.view",
