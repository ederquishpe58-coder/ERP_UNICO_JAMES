...
-- FA-PERF-001 follow-up: preserve bounded server-side filtering/pagination
-- without inventing a maximum business date range.
...
) is 'FA-PERF-001 server-filtered Search-First commercial profitability report; page size bounded, date range unrestricted by invented business rules.';
